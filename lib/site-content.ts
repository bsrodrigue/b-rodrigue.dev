...
export const siteContent = {
  en: {
    ...
    home: {
      ...
      headline: "I build fullstack products for web and mobile.",
      intro:
        "My core stack is React, React Native, Python, Django, and PostgreSQL, with production experience across FinTech, data-heavy platforms, and consulting work.",
      stack: ["React", "React Native", "Python", "Django", "PostgreSQL"],
      ctaPrimary: "View portfolio",
      ctaSecondary: "Read articles",
      proof: [
        { title: "7+ years", text: "shipping products" },
        { title: "Web + mobile", text: "delivery experience" },
    ...
    blog: {
      ...
      description:
        "Articles and reflections on development, systems, and technology.",
      heroTitle: "Blog",
      heroSubtitle:
        "Articles and reflections on development, systems, and technology.",
  ...
  fr: {
    ...
    home: {
      ...
      headline: "Je construis des produits fullstack pour le web et le mobile.",
      intro:
        "Mon stack principal est React, React Native, Python, Django et PostgreSQL, avec une expérience en production dans la FinTech, les plateformes data-intensives et le consulting.",
      stack: ["React", "React Native", "Python", "Django", "PostgreSQL"],
